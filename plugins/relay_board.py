...
if 'plugins.relay_board' not in urls:
...
try:
    if gv.platform == 'pi': # If this will run on Raspberry Pi:
        ...
        gv.logger.error('relay board plugin only supported on pi.')
except:
  gv.logger.error('Relay board: GPIO pins not set')
  pass
...
#                    print 'relay switched off', i + 1, "pin", relay_pins[i]  #  for testing ############
                ...
                gv.logger.error("Problem switching relays" + str(e) + str(relay_pins[i]))
                pass
