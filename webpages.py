...
import gv
from helpers import *
from boiler import template_render
...
class change_options(ProtectedPage):
    ...
    def GET(self):
        ...
        for f in ['ipas', 'tf', 'urs', 'seq', 'rst', 'lg', 'etok', 'tepr', 'tesu']:
...
class view_log(ProtectedPage):
    ...
    def GET(self):
        qdict = web.input()
        records = read_log()
        return template_render.log(0, gv.sd, records)
...
class boiler_log(ProtectedPage):
